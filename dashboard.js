...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const allViews = ['profile-view', 'settings-view', 'app-settings-view', 'bookings-view'];
    ...
    function renderBookings() {
        ...
        const history = JSON.parse(localStorage.getItem('urbanNeedsBookings')) || [];
