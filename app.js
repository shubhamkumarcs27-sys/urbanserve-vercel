...
const ALL_SERVICES = [
  ...
  {
    id: 2,
    name: "Professional Full Rewiring",
    category: "electrician",
    rating: 4.8,
    reviews: 256,
    price: 2499,
  ...
  // --- APPLIANCE REPAIR ---
  {
    ...
    reviews: 305,
    price: 499,
    image: "assets/ac_repair.png?v=2",
    quality: "Budget",
  },
  {
    id: 7,
  ...
  {
    id: 8,
    name: "Washing Machine Motherboard Fix",
    category: "appliance_repair",
    rating: 4.5,
    reviews: 120,
    price: 3500,
  ...
  // --- CLEANING & PEST ---
  {
    ...
    category: "cleaning_pest",
    rating: 4.7,
    reviews: 412,
    price: 899,
    image: "assets/pest_control.png",
    quality: "Standard",
  },
  {
    id: 10,
  ...
  // --- SOFA & CARPET ---
  {
    ...
    category: "sofa_cleaning",
    rating: 4.8,
    reviews: 145,
    price: 999,
    image: "assets/sofa_cleaning.png",
    quality: "Standard",
  },
  {
    id: 13,
    name: "Luxury Carpet Shampooing",
    category: "sofa_cleaning",
    rating: 4.9,
    reviews: 85,
    price: 2499,
  ...
  {
    id: 19,
    name: "Fresh Wall Painting",
    category: "painting",
    rating: 4.6,
    reviews: 305,
    price: 5999,
    image: "assets/painter.png?v=4",
    quality: "Budget",
  },
  {
    id: 20,
  ...
  {
    id: 24,
    name: "RO Water Filter Service",
    category: "ro_service",
    rating: 4.8,
    reviews: 320,
    price: 499,
    image: "assets/ro_service.png",
    quality: "Standard",
  },
  {
    id: 25,
  ...
  // --- VEHICLE CARE ---
  {
    ...
    reviews: 156,
    price: 2999,
    image: "assets/vehicle_care.png",
    quality: "Standard",
  },
  {
    id: 32,
    name: "Luxury Ceramic Coating",
    category: "vehicle_care",
    rating: 5.0,
    reviews: 24,
    price: 15000,
...
function openBooking(sid) {
  ...
  const time =
    document.querySelector(".time-slot.selected")?.innerText || "Selected Time";
  ...
  if (searchInput && searchResults) {
    searchInput.oninput = (e) => {
      ...
      if (filtered.length === 0) {
        searchResults.innerHTML = `<div style="text-align: center; color: var(--text-secondary);">No services found for "${query}"</div>`;
      }
  ...
  for (let i = 0; i < 50; i++) {
    ...
    div.animate(
      [
        ...
        {
          transform: `translate3d(${(Math.random() - 0.5) * 200}px, 400px, 0) rotate(${Math.random() * 360}deg)`,
          opacity: 0,
        },
      ],
      {
